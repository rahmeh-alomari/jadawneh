...
@Component({
  selector: 'app-program-podcaster-card',
  templateUrl: './program-podcaster-card.component.html',
  styleUrls: ['./program-podcaster-card.component.scss']
})
export class ProgramPodcasterCardComponent implements OnInit {
