...
@Component({
	selector: 'app-podcaster-card',
	templateUrl: './podcaster-card.component.html',
	styleUrls: ['./podcaster-card.component.scss'],
})
export class PodcasterCardComponent implements OnInit 
{
